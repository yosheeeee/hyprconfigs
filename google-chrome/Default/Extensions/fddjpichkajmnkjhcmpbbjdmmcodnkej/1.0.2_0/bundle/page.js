...
Object.defineProperty(exports, "__esModule", { value: true });
const PageLoader_1 = __webpack_require__(31);
new PageLoader_1.PageLoader(window).load().then();
...
class PageLoader {
    ...
    async load() {
        try {
            const app = new App_1.App(`PageLoader: ${this.pagePathname}`);
            await app.init();
            const pageApp = await app.createPageApp(this.pagePathname, this.pageWindow);
            await pageApp.init();
        }
        catch (error) {
